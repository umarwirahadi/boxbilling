...
/* partial_menu.phtml */
class __TwigTemplate_2f27cd1ed4f88b640208a8004c9d8ffe730400f0dce9b5ef4fad16f07c05c14b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% for location,group in navigation %}
    ...
    {% endif %}
{% endfor %}
</ul>", "partial_menu.phtml", "C:\\Program Files\\xampp\\htdocs\\boxbilling/bb-themes\\admin_default\\html/partial_menu.phtml");
    }
}
